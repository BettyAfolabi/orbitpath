...
export default function PathfinderPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-300 text-xs tracking-widest uppercase mb-5 md:mb-6 transition-colors"
          >
        ...
        <motion.div
          ...
          className="mt-8 md:mt-10 pt-5 md:pt-6 border-t border-slate-800/60"
        >
          <div className="text-xs text-slate-600 tracking-widest text-center mb-4 md:hidden">
            {step + 1} / {totalSteps}
          </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <button
              onClick={goBack}
              disabled={step === 0}
              className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-300 disabled:opacity-0 disabled:pointer-events-none transition-all duration-200 min-w-15"
            >
            ...
            <div className="text-xs text-slate-600 tracking-widest hidden md:block">
              {step + 1} / {totalSteps}
            </div>
            ...
            {isLast ? (
              <button
                ...
                className="flex items-center gap-2 px-5 md:px-6 py-2.5 md:py-3 rounded-full text-sm font-medium bg-sky-500 hover:bg-sky-400 text-black disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 shadow-lg shadow-sky-500/20"
              >
                {isSubmitting ? (
                  <>
